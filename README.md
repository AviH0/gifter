...
- **OPTIONAL - Meta Tags**: Update the Open Graph and Twitter meta tags in `index.html` and `en/index.html` for social media previews. Replace the content values with your custom title, description, and image URL.
