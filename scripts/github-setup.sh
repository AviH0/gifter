...
echo "GitHub Pages needs to serve files from the /public directory."
echo ""
...
echo "   - Folder: Select '/public' (not root!)"
echo "3. Click 'Save'"
...
echo "• Example: https://cdn.jsdelivr.net/gh/USERNAME/wedding_gifts@main/public/events/UUID/config.enc"
